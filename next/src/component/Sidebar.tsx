    ...
    <aside className="bg-zinc-900 text-white top-0 h-screen overflow-y-auto sticky px-5 md:flex md:justify-between flex-col justify-center gap-10 hidden">
      <div className="flex flex-col mt-4 space-y-3">
        <div className="flex flex-row pb-2">
          ...
          <h1 className="text-2xl font-light text-rose-600">2023</h1>
        </div>
        ...
        <div>
          <div className="flex flex-row">
            ...
            <div className="w-4 h-4" title="Click and Drag on Calendar cells to select times you're available. 'Ctrl + z' to clear selection">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" className="w-4 h-4 transition duration-700 hover:text-blue-400">
