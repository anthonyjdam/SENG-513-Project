        ...
        <div>
          <div className="flex flex-row">
            ...
            <div className="w-4 h-4" title="Click and Drag on Calendar cells to select times you're available. 'Ctrl + z' to clear selection">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.8" stroke="currentColor" className="w-4 h-4 transition duration-700 hover:text-blue-400">
