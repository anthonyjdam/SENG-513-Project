...
function ErrorMessage({ errorMessage }: { errorMessage: string }) {
    return (
        <div className='flex flex-row justify-center m-auto px-2 py-0.5 border border-y-0 border-r-0 border-l-4 border-red-600 bg-red-100 rounded-l-sm rounded-lg transition-all duration-500'>
